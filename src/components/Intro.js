...
const Intro = (props) => {
  return (
    <div className={`${props.classes}`}>
      <h1 className="text-3xl font-medium mb-4 leading-6">INFORMATION</h1>
      ...
      <p className="text-sm"><br/>For information on how to properly measure your bike <a href="https://www.youtube.com/watch?v=nQ-G5ZH46kI" rel="noreferrer" target="_blank">click here</a></p>
    </div>
  )
}
